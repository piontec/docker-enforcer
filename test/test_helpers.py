...
class ApiTestHelper:
    ...
    # docker run -it alpine sh
    authz_req_plain_run_with_tls = b'{"User":"client","UserAuthNMethod":"TLS","RequestMethod":"POST","RequestUri":"/v1.30/containers/create","RequestBody":"","RequestHeaders":{"Content-Length":"1425","Content-Type":"application/json","User-Agent":"Docker-Client/17.06.0-ce (linux)"}}\n'
...
class DefaultRulesHelper:
    ...
    start_request_rules = b'"import json\\nimport threading\\n\\nfrom flask import logging\\n\\nlogger = logging.getLogger(\\"docker_enforcer\\")\\n\\nstart_request_rules = [\\n    {\\n        \\"name\\": \\"always false\\",\\n        \\"rule\\": lambda request: False\\n    }\\n]\\n"'
